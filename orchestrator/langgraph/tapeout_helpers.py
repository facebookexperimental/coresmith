...
def _discover_block_ports(blocks: list[dict]) -> list[dict]:
    ...
    Also loads the block diagram connections from .coresmith/block_diagram.json
...
// Auto-generated by coresmith tapeout_helpers for OpenFrame shuttle submission
//
...
def generate_wrapper_pnr_tcl(
    ...
    # OpenROAD wrapper-PnR script generation lives in the sky130 deployment
    # (PDK data -- tracks/PDN/CTS/fillers/site -- from PDKConfig); the OpenFrame
    # die geometry is a tapeout parameter passed through. Byte-identity guarded
    # by test_pdk_tcl_golden.
    from orchestrator.pdk.deployments import sky130 as _sky130
    script = _sky130.DEPLOYMENT.tools()["run_pnr"].render_wrapper_pnr_tcl(
        abs_netlist, str(sdc_path), "openframe_project_wrapper",
...
def _generate_user_defines_v() -> str:
    ...
    lines = [
        ...
        "// user_defines.v",
        "// Auto-generated by coresmith tapeout_helpers for OpenFrame submission",
        "//",
